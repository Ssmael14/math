        ...
        >
          <div className="grid gap-8 lg:grid-cols-[500px_1fr]">
            <section className="relative">
              <div className="rounded-chunky border border-slate-200 bg-white px-7 py-8 shadow-[0_1px_0_rgba(15,23,42,0.04)] md:px-9 md:py-9 lg:fixed lg:left-(--path-gutter) lg:top-[calc(6rem+env(safe-area-inset-top))] lg:w-[var(--path-sidebar-width)]">
                <div className="relative mb-8 h-20 w-20">
                  ...
                  <div className="absolute left-0 top-7 h-5 w-5 rounded-r-full bg-white" />
                  <div className="absolute -right-1 bottom-5 h-5 w-5 rounded-l-full bg-white" />
                  <div className="absolute inset-0 flex items-center justify-center text-4xl">
                    {path.subject.icon}
                  </div>
                  <div className="absolute -right-2 -top-2 h-6 w-6 rounded-full bg-white/90" />
                </div>

                <h1 className="font-fredoka text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">
                  {path.name}
                </h1>
                {path.description && (
                ...
                <div className="mt-8 flex flex-wrap gap-5 text-sm font-black text-slate-950">
